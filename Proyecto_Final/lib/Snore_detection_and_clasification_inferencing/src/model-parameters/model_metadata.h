...
#define EI_CLASSIFIER_PROJECT_ID                 1035595
#define EI_CLASSIFIER_PROJECT_OWNER              "Big__Floppa"
#define EI_CLASSIFIER_PROJECT_NAME               "Snore detection and clasification"
